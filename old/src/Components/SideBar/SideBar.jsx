...
import { Contracts, SignaturedContracts } from "../../Screens"
...
const SideBar = ({ open, setIsLoading, drawerState, toggleDrawer }) => {
  ...
  const LogoutMutation = useMutation("Profile_Logout_API", {
